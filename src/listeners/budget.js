$(document).ready(function(){
    ...
    budgetjs.getBudget(idWork, function (budget) {
        ...
        for (var product of budgetData) {

            var idBudget = product['id_budget'];
            document.getElementById("budget-id").innerHTML = idBudget;
        ...
        $('.btn-pdf').on('click', function () {
            ...
            domtoimage.toPng(document.getElementById('page')).then(function (blob) {
                ...
                pdf.save("Presupuesto " + year + "-" + idBudget + ".pdf", {returnPromise:true}).then(window.location.href = "customer.html");     
